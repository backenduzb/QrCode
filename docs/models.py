...
class Document(models.Model):
    ...
    file_qr = models.FileField(upload_to="docs_qr/", blank=True, null=True)
    qr = models.ImageField(upload_to="qr/", blank=True, null=True)
    pdf_image = models.ImageField(upload_to="pdf_preview/", blank=True, null=True)
    pdf_image_qr = models.ImageField(upload_to="pdf_preview_qr/", blank=True, null=True)
